...
public class MapLocations extends FragmentActivity implements LocationListener{
	...
	public void addMarker(){
		if (mGoogleMap != null)
		{
//			mGoogleMap.addMarker(new MarkerOptions().position(new LatLng(lat, longitude))
//					.title(c.getString(c.getColumnIndex(DB.LocalDeal.MERCHANT_NAME))).snippet(""));
