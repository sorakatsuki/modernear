...
- (void)setupMapForLocatoion:(CLLocation *)newLocation {
    ...
    location.latitude = 37.8197722;
    location.longitude = -122.478600;
    region.span = span;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if(cell.accessoryType == UITableViewCellAccessoryNone) {
        ...
        NSString *newStr = [cell.detailTextLabel.text substringFromIndex:3];
        [dictionary setObject:cell.textLabel.text forKey:@"name"];
        [dictionary setObject:newStr forKey:@"address"];
        [selectedRows addObject:dictionary];
        ...
        [dictionary setObject:cell.textLabel.text forKey:@"name"];
        [dictionary setObject:newStr forKey:@"address"];
        [selectedRows removeObject:dictionary];
